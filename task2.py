...
entry5 = tk.Entry(window, width=17)
label7 = tk.Label(window, text="Birthdate")
entry6 = tk.Entry(window, width=17)
...
label6.place(x=390, y=105)
entry5.place(x=360, y=125)
label7.place(x=517, y=105)
entry6.place(x=490, y=125)
